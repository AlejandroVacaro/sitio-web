...
> Sitio web personal y profesional de **Alejandro Vacaro** (Analista Funcional, Business Analysis y Optimización de Procesos).
...
- ⚙️ **Enfoque en Análisis Funcional & Procesos**: Business Analysis, implementación de BPMS, rediseño de flujos y articulación negocio-tecnología con más de 15 años de trayectoria.
...
- 📖 **Storytelling Continuo ("Sobre mí")**: Biografía en flujo continuo con panel de lectura y scroll independiente que armoniza con la tarjeta de perfil.
- 💼 **Experiencia Laboral Completa**: República AFAP, Gimnasio Raqis, Iglesia Católica, Estación Petrobras, Corporación Médica de Paysandú, Banco de Previsión Social (BPS), Ta-Ta S.A.
- 🎓 **Formación Académica**: Contador Público (UDELAR - en curso), Business Analysis (UTN), Analista de Datos Python (Senpai), Full Stack MERN (Coderhouse), Inglés B1 (Bike).
- 📄 **Descarga de CV en PDF**: Enlace directo al archivo PDF oficial.
- ✉️ **Canales y Redes Oficiales (SVG)**: WhatsApp, LinkedIn, TikTok, Instagram, X (Twitter) y Correo Electrónico.
...
│   └── images/                 # Fotografías oficiales de Alejandro Vacaro
